void buzzer_func(){
  ...
  if(digitalRead(button[1])==HIGH){tone(buzzer,NOTE_DS5,100);}
  if(digitalRead(button[2])==HIGH){tone(buzzer,NOTE_F5,100);}
  if(digitalRead(button[3])==HIGH){tone(buzzer,NOTE_GS5,100);}
  if(digitalRead(button[4])==HIGH){tone(buzzer,NOTE_B5,100);}
  ////
